...
curl -X GET https://management.azure.com/subscriptions/$SUBID/providers/Microsoft.Compute/virtualMachines?api-version=2024-03-01 -H "Authorization : Bearer $TOKEN" | jq -r '.value[].name' 
